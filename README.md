# Auto-Fairey
This is a program created to help citizens pay a fair price for their auto. It allows users to input 2 locations and get the fair auto pricing for travel between them.
